...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        BLDC_Speed_Bar = new QSlider(centralwidget);
        BLDC_Speed_Bar->setObjectName("BLDC_Speed_Bar");
        BLDC_Speed_Bar->setGeometry(QRect(970, 210, 22, 141));
        ...
        BLDC_Toggle_Button->setGeometry(QRect(850, 320, 75, 35));
        BLDC_Status_Text = new QLabel(centralwidget);
        BLDC_Status_Text->setObjectName("BLDC_Status_Text");
        BLDC_Status_Text->setGeometry(QRect(813, 240, 150, 35));
        QFont font;
        ...
        BLDC_Status_Label->setGeometry(QRect(850, 275, 75, 35));
        QPalette palette;
        ...
        BLDC_Speed_Label = new QLabel(centralwidget);
        BLDC_Speed_Label->setObjectName("BLDC_Speed_Label");
        BLDC_Speed_Label->setGeometry(QRect(950, 360, 63, 20));
        BLDC_Speed_Label->setAlignment(Qt::AlignmentFlag::AlignCenter);
        frame = new QFrame(centralwidget);
        frame->setObjectName("frame");
        frame->setGeometry(QRect(10, 10, 400, 200));
